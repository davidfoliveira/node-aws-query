        ...
        if ( prop.match(/^describe/) && typeof awsRealModule.constructor.prototype[prop] == "function" ) {
            ...
            self[prop] = function(){
                var
                    ...
                    cacheID     = region+"/"+moduleName+"."+prop+"("+argStr.substr(1,argStr.length-2)+")";
                ...
                args.push(function(err, results){
                    ...
                    return aws.cache.set(cacheID, results, function(err){
                        if ( err ) {
                ...
                aws.cache.get(cacheID, function(err, results){
                    if ( err ) {

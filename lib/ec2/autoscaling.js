...
exports.select = function(region, selector, callback) {
    ...
    return self.getAutoscalingGroupsByName(region, names, { getTags: true }, function(err, list){
        ...
        return callback(null, self.aws.blessResources("ELB", "AutoScalingGroupName", region, {"Instances": "EC2", "LoadBalancerNames": "ELB"}, self.aws.filterResources(list, selector)));
    });
